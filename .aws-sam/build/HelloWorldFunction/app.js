...
class EventRegistrationDocument {
    constructor() {
        this.Pages = [];
    }
}
exports.EventRegistrationDocument = EventRegistrationDocument;
class EventRegistrationPage {
    // From: first index (starting from 1)
    // To: last index 
    constructor(event, from, to) {
        this.HostName = '';
        this.EventType = '';
        this.EventZipCode = '';
        this.EventDate = '';
        this.RegistrantPageSections = [];
...
exports.EventRegistrationPage = EventRegistrationPage;
class RegistrantPageSection {
    constructor(r) {
        this.FirstName = [];
        this.LastName = [];
        this.Email = [];
        this.Phone = [];
        this.ZipCode = [];
        this.MAXCHARS_FIRSTNAME = 14;
        this.MAXCHARS_LASTNAME = 15;
        this.MAXCHARS_EMAIL = 34;
        this.MAXCHARS_PHONE = 10;
        this.MAXCHARS_ZIPCODE = 5;
    ...
    createCharacterArray(s, maxCharacters) {
        let a = [];
        if (s === null) {
            return a;
        }
...
exports.RegistrantPageSection = RegistrantPageSection;


/***/ }),

/***/ "./src/form-builder/processCsvData.ts":
/*!********************************************!*\
  !*** ./src/form-builder/processCsvData.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const classes_1 = __webpack_require__(/*! ./classes */ "./src/form-builder/classes.ts");
const parse = __webpack_require__(/*! csv-parse/lib/sync */ "./node_modules/csv-parse/lib/sync.js");
function processCsvData(csvData, excludeNonAttendees = true) {
    const e = new classes_1.EventRegistrations();
    let rawEventData = parse(csvData, {
        columns: true,
    ...
    rawEventData.forEach(x => {
        let r = new classes_1.Registrant();
...
/***/ "./src/form-builder/renderHtmlOutput.ts":
/*!**********************************************!*\
  !*** ./src/form-builder/renderHtmlOutput.ts ***!
  \**********************************************/
/*! no static exports found */
...
function renderHtmlOutput(evt) {
    let numRegistrants = evt.Registrants.length;
    let numPages = Math.ceil(numRegistrants / REGISTRANTS_PER_PAGE);
    let doc = new classes_1.EventRegistrationDocument();
    for (let index = 0; index < numPages; index++) {
        let p = new classes_1.EventRegistrationPage(evt, index * REGISTRANTS_PER_PAGE + 1, index * REGISTRANTS_PER_PAGE + 4);
        doc.Pages.push(p);
    }
...
exports.renderHtmlOutput = renderHtmlOutput;
...
Object.defineProperty(exports, "__esModule", { value: true });
const processCsvData_1 = __webpack_require__(/*! ../form-builder/processCsvData */ "./src/form-builder/processCsvData.ts");
const renderHtmlOutput_1 = __webpack_require__(/*! ../form-builder/renderHtmlOutput */ "./src/form-builder/renderHtmlOutput.ts");
...
exports.lambdaHandler = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let eventData = processCsvData_1.processCsvData(csvData);
        eventData.HostName = hostName;
        eventData.EventZipCode = eventZipCode;
        let eventHtml = renderHtmlOutput_1.renderHtmlOutput(eventData);
        response = {
            'statusCode': 200,
            'headers': {
